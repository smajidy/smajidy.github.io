...
My name is Shayan Majidy, and I’m a [Banting Postdoctoral Fellow](https://banting.fellowships-bourses.gc.ca/en/home-accueil.html) in Misha Lukin’s group at Harvard. My research interests are in quantum computing, many-body physics, and quantum error correction. Currently, I’m focused on advancing quantum algorithm implementation and exploring many-body dynamics through logical circuit design. This involves developing and optimizing protocols for simulating many-body quantum phenomena on NISQ (noisy intermediate-scale quantum) and early-stage fault-tolerant quantum computers.
