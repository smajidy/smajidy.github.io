/* Existing jQuery and responsive navigation, extracted unchanged from the original bundle.
 * Unused FitVids, Magnific Popup, smooth-scroll and Stickyfill plugins were removed.
 * jQuery copyright jQuery Foundation and other contributors; MIT licence (jquery.org/license).
 * Theme licence: see LICENSE.
 */
...
$btn.on("click",function(){$hlinks.toggleClass("hidden"),$(this).toggleClass("close")});
updateNav();
